    ...
    public partial class SystemCleaningControl : UserControl, ISystemCleaningControlView
    {
        ...
        private Panel CreateDrivePanel(DriveInfoModel dInfo)
        {
            Panel panel = new Panel
            {
                ...
                BackColor = Globals.GlobalSettings.BackgroundColor,
                Tag = dInfo
            };

            CheckBox checkBox = new CheckBox
            {
                ForeColor = Globals.GlobalSettings.TextColor,
        ...
        {
            Panel panel = new Panel { AutoSize = true, BorderStyle = BorderStyle.FixedSingle, Padding = new Padding(10), BackColor = Globals.GlobalSettings.BackgroundColor };
            ...
            foreach (var opt in CleaningRules.Rules[disk.DiskType])
            {
                ...
                CheckBox cb = new CheckBox
                {
                    ...
                    BackColor = Globals.GlobalSettings.BackgroundColor,
                    ForeColor = allowed ? Globals.GlobalSettings.TextColor : Color.Red,
                    Tag = opt,
                    Checked = allowed
                };
